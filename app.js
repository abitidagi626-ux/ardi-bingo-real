...
function startBingoArena(stake) {
    ...
    markedByPlayer.add("F"); // Free space
...
// ነጥብ 3: Bingo 1 Line logic
function checkBingoWin(card) {
    const wins = [
    ...
    const hasWon = wins.some(w => w.every(i => markedByPlayer.has(i === 12 ? "F" : card[i])));
