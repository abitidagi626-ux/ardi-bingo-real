...
function init() {
    ...
    stakes.forEach(s => {
        ...
        row.innerHTML = `
            ...
            <button onclick="handleJoinRequest(${s})" style="background:#efae10; border:none; border-radius:4px; padding:4px; cursor:pointer; font-weight:bold; font-size:11px;">Join »</button>`;
